...
function validate() {
    return function(req, res) {
        if (!req.body || !req.body.Script) {
            console.log("The request failed because it was missing the string:\n" + JSON.stringify(req.body));
            return res.status(400).send("You need to provide a string of JSON code to execute.");
        }
        ...
        try {
            ...
            console.log("The execution of the JSON document:\n" + req.body.Script + "\nAnd Context:\n" + JSON.stringify(req.body.context) + "\nFailed with error:\n" + e);
            return res.status(400).send("Was not able to process the response from the JSON document you provided.\n\n" + e);
        }
...
app.post("/Execute", jsonParser, validate());
